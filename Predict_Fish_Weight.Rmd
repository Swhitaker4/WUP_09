...
Subset of fish that contains the speciesis what  I want to analyze, then I will look at how well each combination of the predictor variables can predict the weight of the fish.I am using the perch subset in my analysis. 
...
```{r}
secondOrder=lm(Weight~I(Length1^2),data=Perch)
...
$H_A$:there is a difference between models 1 and 2 when predicting th weight of the fish (Perch)
```{r}
